...
def get_model(num_users, num_items, layers = [20,10], reg_layers=[0,0]):
    ...
    MLP_Embedding_User = Embedding(input_dim = num_users, output_dim = int(layers[0]/2), name = 'user_embedding',
                                  input_length=1)(user_input) # init = init_normal, W_regularizer = l2(reg_layers[0]),
    ...
    vector = Concatenate()([user_latent, item_latent]) # merge([user_latent, item_latent], mode = 'concat')
